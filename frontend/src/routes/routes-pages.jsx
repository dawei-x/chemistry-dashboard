...
import { AgentChatPanel, BaselineChatPanel, V3ChatPanel, V4ChatPanel, V5ChatPanel, V6ChatPanel, V7ChatPanel, V8ChatPanel } from '../components/agent-chat';
    ...
    return (
        <BrowserRouter>
            <Routes>
                ...
                <Route path='/chat-v8' element={<ProtectedRoute component={V8ChatPanel} />}/>
