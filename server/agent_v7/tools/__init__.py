...
from .artifact_tools import (
    ...
    search_for_sessions,
    find_sessions_by_structure,  # Signal-based session discovery
    get_transcript,
    get_concept_map,
    get_7c_analysis,
    get_liwc_metrics,
...
COMBINED_TOOLS = {
    ...
    "find_sessions_by_structure": find_sessions_by_structure,  # Signal-based discovery
...
__all__ = [
    ...
    'list_sessions',
    'search_for_sessions',
    'find_sessions_by_structure',  # Signal-based discovery
    'get_transcript',
    'get_concept_map',
    'get_7c_analysis',
    'get_liwc_metrics',
