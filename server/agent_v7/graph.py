...
# NOTE: verify_claims and reflect removed - they were no-ops for PRAS path
...
def create_agent_graph() -> StateGraph:
    ...
    # Synthesis (shared by both paths)
    ...
    # Stage 4 -> format (verify/reflect removed - they were no-ops)
    graph.add_edge("pras_synthesize", "format")

    # Fast path: synthesize -> format
